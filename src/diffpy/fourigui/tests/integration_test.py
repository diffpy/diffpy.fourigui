...
def test_data():
    # set up test data
    return {
        "test_sofq": h5py.File("src/diffpy/fourigui/tests/testdata/sofq.h5")["data"],
        "test_sofq_cut_10to40px": h5py.File("src/diffpy/fourigui/tests/testdata/sofq_cut_10to40px.h5")["data"],
        "test_sofq_cut_15to35px": h5py.File("src/diffpy/fourigui/tests/testdata/sofq_cut_15to35px.h5")["data"],
        "test_gofr": h5py.File("src/diffpy/fourigui/tests/testdata/gofr.h5")["data"],
        "test_gofr_cut_10to40px": h5py.File("src/diffpy/fourigui/tests/testdata/gofr_from_sofq_cut_10to40px.h5")[
            "data"
        ],
        "test_gofr_cut_15to35px": h5py.File("src/diffpy/fourigui/tests/testdata/gofr_from_sofq_cut_15to35px.h5")[
            "data"
        ],
    }
...
def test_load_cube_testdataset1(gui, test_data):
    ...
    gui.filename_entry.insert(0, "src/diffpy/fourigui/tests/testdata/sofq.h5")
...
def test_load_cube_testdataset2(gui, test_data):
    # given
    gui.filename_entry.delete(0, "end")
    gui.filename_entry.insert(0, "src/diffpy/fourigui/tests/testdata/sofq_cut_10to40px.h5")
...
def test_load_cube_testdataset3(gui, test_data):
    # given
    gui.filename_entry.delete(0, "end")
    gui.filename_entry.insert(0, "src/diffpy/fourigui/tests/testdata/sofq_cut_15to35px.h5")
